    ...
    if (isset($_GET["close"])) {
        ...
        try {
            ...
            if ($donnees['steamid'] == $_SESSION['steamid']) {
                ...
                set_flash("Our System got an error! Please contact us by mail!" . $e, "warning");
                redirect("support.php");
            }
            set_flash("You successfully closed the Support ticket.", "success");
            redirect("support.php");
    ...
    <div id="main-wrapper">
        ...
        <div class="container">
            ...
            <table class="table table-striped">
                ...
                <?php
                $req = $db->query('SELECT id, steamid, active, message, DATE_FORMAT(date_creation, \'%m/%d/%Y at %H:%i\') AS date_creation_fr FROM support WHERE steamid="' . $_SESSION['steamid'] . '" ORDER BY date_creation DESC LIMIT 0, 10');
                ...
                if ($nb == 0) {
                    ?>
                    <p style="text-align: center;"><b style="color:#e74c3c;">You have no active support tickets.</b></p>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 ">
                    <form action="support_post.php" method="post" class="contact-form">
