<div id="header-wrapper">
    <div id="header" class="container">
        ...
        <h1 id="logo">
            <a href="index.php">
        <img src="images/gold_mine.png" width="9%" height="9%">        CS:GOLDMINE <img src="images/gold_mine.png" width="9%" height="9%">
            </a>
        </h1>
        <p>
        ...
        <nav id="nav">
            <ul class="centered">
                ...
                {
                    echo '<div class="userinfo" style="float:right;">';
                    loginbutton();
                    ?>
                ...
                {
                    echo '<div class="userinfo col-md-3" style="float:right;">';
                ...
                if($req[0] == 0)
                {
                    ...
                    //$SQL = "INSERT INTO users VALUES ('','$steam_id','$steam_username','$steam_avatar_little','$steam_avatar_medium','$steam_profileurl',NOW(),'$steam_status','','','',0,'".$_SERVER['REMOTE_ADDR']."')";
                    $db->beginTransaction();
                    $db->query($SQL);
                    $db->commit();
                ...
                ?>
                    ...
                    <a href="#" class="icon fa-steam">
                        ...
                        <small><?php echo $_SESSION['username']; ?>  |  <img src="images/coins.png" height="24" width="24" alt="Points"> <?php echo $points; ?>
                        </small>
